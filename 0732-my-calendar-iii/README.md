<h2><a href="https://leetcode.com/problems/my-calendar-iii/?envType=problem-list-v2&envId=24ma7sot">732. My Calendar III</a></h2><h3>Hard</h3><hr><p>A <code>k</code>-booking happens when <code>k</code> events have some non-empty intersection (i.e., there is some time that is common to all <code>k</code> events.)</p>
