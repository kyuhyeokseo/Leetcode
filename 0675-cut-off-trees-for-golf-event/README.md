<h2><a href="https://leetcode.com/problems/cut-off-trees-for-golf-event/?envType=problem-list-v2&envId=24ma7sot">675. Cut Off Trees for Golf Event</a></h2><h3>Hard</h3><hr><p>You are asked to cut off all the trees in a forest for a golf event. The forest is represented as an <code>m x n</code> matrix. In this matrix:</p>
