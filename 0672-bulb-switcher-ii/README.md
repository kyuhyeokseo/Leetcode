<h2><a href="https://leetcode.com/problems/bulb-switcher-ii/?envType=problem-list-v2&envId=24ma7sot">672. Bulb Switcher II</a></h2><h3>Medium</h3><hr><p>There is a room with <code>n</code> bulbs labeled from <code>1</code> to <code>n</code> that all are turned on initially, and <strong>four buttons</strong> on the wall. Each of the four buttons has a different functionality where:</p>
